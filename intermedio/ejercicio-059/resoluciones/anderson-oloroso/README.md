# ✨ Solución ejercicio intermedio: 59

## _Henrik Anderson Oloroso García 💯_

### Creación de las tablas 📑

Se crearon dos tablas relacionadas para la temática **marketplace de accesorios**:
- `accesorios_market` (Tabla principal con PK `accesorio_id`)
- `ventas_accesorios` (Tabla secundaria relacionada mediante FK `accesorio_id`)
