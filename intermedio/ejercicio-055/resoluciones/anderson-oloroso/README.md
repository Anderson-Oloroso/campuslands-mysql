# ✨ Solución ejercicio intermedio: 55

## _Henrik Anderson Oloroso García 💯_

### Creación de las tablas 📑

Se crearon dos tablas relacionadas para la temática **laboratorio de formulas quimicas**:
- `formulas_quimicas` (Tabla principal con PK `formula_id`)
- `reactivos_quimicos` (Tabla secundaria relacionada mediante FK `formula_id`)
