...
## Que hice
Modele sesiones de juego en `sesiones_juego_intermedio` y escribi seis
consultas de reporte: resumen por jugador, un reporte con `ROLLUP`,
una metrica calculada (ratio derrotas/muertes), un reporte mensual,
un porcentaje sobre el total, y un ranking.
...
## Consultas incluidas
1. Resumen por jugador (sesiones, tiempo total, promedio de enemigos).
...
5. Porcentaje de sesiones sin ninguna muerte.
