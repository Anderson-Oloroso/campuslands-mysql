# ✨ Solución ejercicio intermedio: 39

## _Henrik Anderson Oloroso García 💯_

### Creación de las tablas 📑

Se crearon dos tablas relacionadas para la temática **kickboxing**:
- `peleadores_kickboxing` (Tabla principal con PK `peleador_id`)
- `combates_kickboxing` (Tabla secundaria relacionada mediante FK `peleador_id`)
