...
CREATE DATABASE IF NOT EXISTS intermedio_paracaidismo;
...
DROP TABLE IF EXISTS zonas_salto_019;

-- Creación de tablas principales

CREATE TABLE zonas_salto_019 (
    id INT AUTO_INCREMENT PRIMARY KEY,
    nombre_dropzone VARCHAR(80) NOT NULL,
    ubicacion VARCHAR(100) NOT NULL,
    altitud_max_pies INT NOT NULL CHECK(altitud_max_pies >= 5000)
);
...
CREATE TABLE saltos_019 (
    ...
    FOREIGN KEY (zona_id) REFERENCES zonas_salto_019(id)
);