# ✨ Solución ejercicio intermedio: 33

## _Henrik Anderson Oloroso García 💯_

### Creación de las tablas 📑

Se crearon dos tablas relacionadas para la temática **inventario de skins shooter**:
- `armas_shooter` (Tabla principal con PK `arma_id`)
- `skins_shooter` (Tabla secundaria relacionada mediante FK `arma_id`)
