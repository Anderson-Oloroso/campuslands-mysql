# ✨ Solución ejercicio intermedio: 57

## _Henrik Anderson Oloroso García 💯_

### Creación de las tablas 📑

Se crearon dos tablas relacionadas para la temática **videojuego de accion y aventura**:
- `niveles_aventura` (Tabla principal con PK `nivel_id`)
- `logros_nivel` (Tabla secundaria relacionada mediante FK `nivel_id`)
