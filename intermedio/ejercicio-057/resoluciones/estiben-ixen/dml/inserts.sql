-- Insercion de datos para videojuego de accion y aventura (ejercicio-057)
USE campuslands_mysql;

-- 1. Insercion en tabla principal (reinos_aventura)
...
-- 2. Insercion en tabla secundaria (artefactos_magicos)
