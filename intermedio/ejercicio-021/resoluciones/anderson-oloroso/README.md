# ✨ Solución ejercicio intermedio: 21

## _Henrik Anderson Oloroso García 💯_

### Creación de las tablas 📑

Se crearon dos tablas relacionadas para la temática **dibujo digital**:
- `ilustraciones_digitales` (Tabla principal con PK `ilustracion_id`)
- `capas_ilustracion` (Tabla secundaria relacionada mediante FK `ilustracion_id`)
