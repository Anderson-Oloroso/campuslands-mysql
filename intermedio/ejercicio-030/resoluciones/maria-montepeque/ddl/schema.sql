...
DROP TABLE IF EXISTS streamers_intermedio;
DROP TABLE IF EXISTS streamers_staging_intermedio;
...
CREATE TABLE streamers_staging_intermedio (
...
CREATE TABLE streamers_intermedio (
  ...
  CONSTRAINT chk_streamers_intermedio_seguidores CHECK (seguidores >= 0)
);
