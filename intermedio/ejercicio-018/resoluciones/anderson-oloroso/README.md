# ✨ Solución ejercicio intermedio: 18

## _Henrik Anderson Oloroso García 💯_

### Creación de las tablas 📑

Se crearon dos tablas relacionadas para la temática **viajes y turismo**:
- `paquetes_turisitcos` (Tabla principal con PK `paquete_id`)
- `reservas_viajes` (Tabla secundaria relacionada mediante FK `paquete_id`)
