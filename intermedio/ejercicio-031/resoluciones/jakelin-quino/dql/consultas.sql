...
FROM ejercicio-031-jugadores j
INNER JOIN ejercicio-031-equipos e ON j.equipo_id = e.id
...
FROM ejercicio-031-equipos e
INNER JOIN ejercicio-031-jugadores j ON e.id = j.equipo_id
GROUP BY e.id
