-- Ejercicio 031 - Intermedio
-- Tablas para torneo de e-sports MOBA con INNER JOIN

CREATE TABLE ejercicio-031-equipos (
...
CREATE TABLE ejercicio-031-jugadores (
    id INT PRIMARY KEY AUTO_INCREMENT,
    equipo_id INT,
    ...
    FOREIGN KEY (equipo_id) REFERENCES ejercicio-031-equipos(id)
);