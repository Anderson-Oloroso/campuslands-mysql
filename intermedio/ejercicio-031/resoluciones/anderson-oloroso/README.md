# ✨ Solución ejercicio intermedio: 31

## _Henrik Anderson Oloroso García 💯_

### Creación de las tablas 📑

Se crearon dos tablas relacionadas para la temática **torneo esports MOBA**:
- `equipos_moba` (Tabla principal con PK `equipo_id`)
- `jugadores_moba` (Tabla secundaria relacionada mediante FK `equipo_id`)
