...
(`clientes_taller_intermedio`, `citas_taller_intermedio`) y escribi
...
2. Citas mas caras que el promedio de su propio tipo de servicio.
...
6. Cita mas cara registrada por cada tipo de servicio.
