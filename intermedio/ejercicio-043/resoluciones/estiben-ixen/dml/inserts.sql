-- Insercion de datos para catalogo de peliculas de miedo (ejercicio-043)
USE campuslands_mysql;

-- 1. Insercion en tabla principal (directores_terror)
INSERT INTO directores_terror (nombre, nacionalidad, premios_obtenidos) VALUES
('James Wan', 'Australia', 8),
('Ari Aster', 'Estados Unidos', 5),
('Jordan Peele', 'Estados Unidos', 6),
('Guillermo del Toro', 'Mexico', 14),
('Mike Flanagan', 'Estados Unidos', 4),
('John Carpenter', 'Estados Unidos', 11);

-- 2. Insercion en tabla secundaria (peliculas_terror)
