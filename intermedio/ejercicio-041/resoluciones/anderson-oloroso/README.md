# ✨ Solución ejercicio intermedio: 41

## _Henrik Anderson Oloroso García 💯_

### Creación de las tablas 📑

Se crearon dos tablas relacionadas para la temática **pingpong**:
- `jugadores_pingpong` (Tabla principal con PK `jugador_id`)
- `partidos_pingpong` (Tabla secundaria relacionada mediante FK `jugador_id`)
