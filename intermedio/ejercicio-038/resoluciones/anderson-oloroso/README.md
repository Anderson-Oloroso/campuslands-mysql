# ✨ Solución ejercicio intermedio: 38

## _Henrik Anderson Oloroso García 💯_

### Creación de las tablas 📑

Se crearon dos tablas relacionadas para la temática **futbol sala**:
- `equipos_futsal` (Tabla principal con PK `equipo_id`)
- `jugadores_futsal` (Tabla secundaria relacionada mediante FK `equipo_id`)
