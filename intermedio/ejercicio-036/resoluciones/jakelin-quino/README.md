# Ejercicio 036 - Nivel Intermedio - Normalización 1FN Autos Hiperdeportivos
...
- **Diseño de Tablas (DDL):**
  - 3 tablas normalizadas:
    - `ejercicio-036-int-marcas`: información única de marcas.
    - `ejercicio-036-int-autos`: datos principales del auto.
    - `ejercicio-036-int-especificaciones`: detalles técnicos.
