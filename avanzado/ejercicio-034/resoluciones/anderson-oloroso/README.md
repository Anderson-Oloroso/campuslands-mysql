# ✨ Solución ejercicio avanzado: 34

## _Henrik Anderson Oloroso García 💯_

### Creación de las tablas 📑

Se crearon las tablas necesarias para la solución avanzada en **garaje de motos**:
- `garaje_motos`
- `mantenimientos_motos`
- `log_auditoria_garaje_motos`
