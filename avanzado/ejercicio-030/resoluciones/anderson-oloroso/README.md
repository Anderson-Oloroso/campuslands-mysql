# ✨ Solución ejercicio avanzado: 30

## _Henrik Anderson Oloroso García 💯_

### Creación de las tablas 📑

Se crearon las tablas necesarias para la solución avanzada en **equipo de streaming**:
- `streamers_equipo`
- `transmisiones_stream`
- `log_auditoria_streamers_equipo`
