# ✨ Solución ejercicio avanzado: 46

## _Henrik Anderson Oloroso García 💯_

### Creación de las tablas 📑

Se crearon las tablas necesarias para la solución avanzada en **restaurante de comida urbana**:
- `platillos_urbanos`
- `pedidos_platillos`
- `log_auditoria_platillos_urbanos`
