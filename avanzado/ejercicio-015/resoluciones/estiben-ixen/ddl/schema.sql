...
-- Tema: biblioteca gamer (optimizacion)
-- Ejecutar este archivo antes de inserts.sql

CREATE DATABASE IF NOT EXISTS campuslands_mysql;
USE campuslands_mysql;

DROP TABLE IF EXISTS log_auditoria_gamer_lib;
...
CREATE INDEX idx_gamer_lib_fk ON videojuegos_catalogo(id_estudio);
CREATE INDEX idx_gamer_lib_metric ON videojuegos_catalogo(metacritic_score DESC);
CREATE INDEX idx_gamer_lib_compuesto ON videojuegos_catalogo(id_estudio, metacritic_score);
