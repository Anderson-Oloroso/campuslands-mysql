...
SELECT * FROM `ejercicio-038-adv-jugadores`;

-- 2. Ver usuarios y roles
SELECT username, rol FROM `ejercicio-038-adv_usuarios`;
...
SELECT j.*, u.rol 
FROM `ejercicio-038-adv-jugadores` j
CROSS JOIN `ejercicio-038-adv_usuarios` u
WHERE u.username = 'entrenador';

-- 7. Insertar nuevo jugador (simulado con validación)
INSERT INTO `ejercicio-038-adv-jugadores` 
