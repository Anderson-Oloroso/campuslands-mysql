# Resolucion - Ejercicio 054 (avanzado)

## Autor
maria-montepeque

## Que hice
Modele el stock de materiales de un taller de soldadura
(`stock_soldadura_avanzado`) y practique dos mecanismos de bloqueo de
MySQL/InnoDB en `dml/inserts.sql`:
...
`17:45:35.218` hasta las `17:45:38.305` (unos **3.1 segundos**), justo
