# ✨ Solución ejercicio avanzado: 54

## _Henrik Anderson Oloroso García 💯_

### Creación de las tablas 📑

Se crearon las tablas necesarias para la solución avanzada en **soldadura**:
- `trabajos_soldadura`
- `inspecciones_soldadura`
- `log_auditoria_trabajos_soldadura`
