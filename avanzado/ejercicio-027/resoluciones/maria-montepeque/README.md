...
## Que hice
Modele enfrentamientos contra jefes en `enfrentamientos_avanzado` (el
daño infligido sube en cada intento, simulando la curva de aprendizaje
real de un jugador) y escribi seis consultas con funciones de ventana:

1. **`RANK() OVER`**: posicion de cada jugador segun su daño total
   infligido en todos sus enfrentamientos.
...
5. **`NTILE(4) OVER`**: divide todos los enfrentamientos en cuatro
   cuartiles segun el daño infligido.
...
5. Cuartiles de enfrentamientos segun el daño (`NTILE`).
