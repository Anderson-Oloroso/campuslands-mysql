...
-- Tema: catalogo de peliculas de miedo (JSON en MySQL)
-- Ejecutar este archivo antes de inserts.sql

CREATE DATABASE IF NOT EXISTS campuslands_mysql;
USE campuslands_mysql;

DROP TABLE IF EXISTS log_auditoria_peliculas_miedo;
...
ALTER TABLE peliculas_terror ADD COLUMN IF NOT EXISTS metadata_json JSON;
