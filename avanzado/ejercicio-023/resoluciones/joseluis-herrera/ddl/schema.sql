...
CREATE ROLE IF NOT EXISTS 'rol_arquitectura_lectura';

CREATE ROLE IF NOT EXISTS 'rol_arquitectura_gestion';


-- Rol de lectura:
-- puede consultar las tres tablas.

GRANT SELECT
ON campuslands_mysql.clientes
...
-- Rol de gestión:
-- puede consultar y modificar proyectos,
-- pero solamente consultar clientes y arquitectos.

GRANT SELECT
ON campuslands_mysql.clientes
TO 'rol_arquitectura_gestion';
