# ✨ Solución ejercicio avanzado: 57

## _Henrik Anderson Oloroso García 💯_

### Creación de las tablas 📑

Se crearon las tablas necesarias para la solución avanzada en **videojuego de accion y aventura**:
- `niveles_aventura`
- `logros_nivel`
- `log_auditoria_niveles_aventura`
