...
FROM `ejercicio-037-adv-estadisticas` es
INNER JOIN `ejercicio-037-adv-equipos` e ON es.equipo_id = e.id
INNER JOIN `ejercicio-037-adv-temporadas` t ON es.temporada_id = t.id;
