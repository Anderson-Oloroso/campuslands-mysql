...
FROM inventario_soldadura_avanzado
ORDER BY stock ASC;
...
WHERE OBJECT_NAME = 'inventario_soldadura_avanzado';
...
--   Sesion B (1 segundo despues): UPDATE inventario_soldadura_avanzado SET stock = stock - 1 WHERE id_material = 2;
