# Resolucion - Ejercicio 055 (avanzado)

## Autor
maria-montepeque

## Que hice
Cree el catalogo `reactivos_avanzado` de un laboratorio de formulas
...
`ERROR 1146 (42S02): Table 'campuslands_mysql.reactivos_avanzado'
