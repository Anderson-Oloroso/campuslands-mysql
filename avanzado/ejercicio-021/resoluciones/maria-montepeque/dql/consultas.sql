...
EXPLAIN
SELECT id_encargo, cliente, tipo_arte, precio
...
SELECT id_encargo, cliente, tipo_arte, precio
FROM encargos_avanzado
WHERE UPPER(artista) = 'LUCIA NIETO';
...
FROM encargos_avanzado
WHERE artista = 'Mateo Salas' AND fecha_encargo BETWEEN '2026-01-01' AND '2026-02-28';
