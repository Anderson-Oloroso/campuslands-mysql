# ✨ Solución ejercicio avanzado: 25

## _Henrik Anderson Oloroso García 💯_

### Creación de las tablas 📑

Se crearon las tablas necesarias para la solución avanzada en **laboratorio de formulas quimicas**:
- `formulas_quimicas`
- `reactivos_quimicos`
- `log_auditoria_formulas_quimicas`
