# Resolucion - Ejercicio 052 (basico)

## Autor
maria-montepeque

## Que hice
Cree la tabla `renders_estudio_basico` para los renders de un estudio
de animacion 3D y escribi seis consultas centradas en `ORDER BY`:
orden simple ascendente y descendente, orden por varias columnas,
orden por una expresion calculada y orden logico personalizado con
`FIELD()`.
