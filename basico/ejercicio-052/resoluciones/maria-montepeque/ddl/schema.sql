...
DROP TABLE IF EXISTS renders_estudio_basico;

CREATE TABLE renders_estudio_basico (
  ...
  CONSTRAINT chk_renders_estudio_basico_tiempo CHECK (tiempo_render_min > 0),
  CONSTRAINT chk_renders_estudio_basico_calidad CHECK (calidad_puntaje BETWEEN 0 AND 10)
);
