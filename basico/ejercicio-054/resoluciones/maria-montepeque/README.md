# Resolucion - Ejercicio 054 (basico)

## Autor
maria-montepeque

## Que hice
Cree la tabla `registros_soldadura_basico` para un taller de soldadura
y practique tres formas de `DELETE` controlado: por `PRIMARY KEY`, por
...
2. Confirmar que no quedan registros cancelados.
...
6. Registros pendientes o en proceso.
