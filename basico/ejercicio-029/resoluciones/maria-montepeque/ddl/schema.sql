...
DROP TABLE IF EXISTS pedidos_basico;

CREATE TABLE pedidos_basico (
  ...
  CONSTRAINT chk_pedidos_basico_precio CHECK (precio > 0),
  CONSTRAINT chk_pedidos_basico_fechas CHECK (fecha_entrega_estimada >= fecha_pedido)
);
