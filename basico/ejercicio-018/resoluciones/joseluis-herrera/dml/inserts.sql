...
VALUES
    ...
    ('Cancún', 'México', 'Playa', 3200.00, TRUE, '2026-08-03'),
    ('Ciudad de México', 'México', 'Ciudad', 2500.00, TRUE, '2026-08-04'),
    ('San José', 'Costa Rica', 'Ciudad', 2800.00, TRUE, '2026-08-05'),
    ...
    ('Buenos Aires', 'Argentina', 'Ciudad', 4200.00, FALSE, '2026-08-09'),
    ('Machu Picchu', 'Perú', 'Arqueológico', 3800.00, TRUE, '2026-08-10');