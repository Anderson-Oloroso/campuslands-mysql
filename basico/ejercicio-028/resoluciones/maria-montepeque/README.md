...
## Que hice
Cree la tabla `estudiantes_basico` para una academia tech y escribi
...
- `estado ENUM('activo','pausado','graduado','retirado')` como
  catalogo cerrado del ciclo de vida de un estudiante.
...
3. Estudiantes que no estan activos.
