-- 1. Top 3 por puntaje
SELECT nick, puntaje, nivel FROM `ejercicio-032-bas-jugadores` 
ORDER BY puntaje DESC LIMIT 3;

-- 2. Jugadores activos con >50 victorias
SELECT nick, victorias, tasa_win FROM `ejercicio-032-bas-jugadores` 
...
FROM `ejercicio-032-bas-jugadores`;

-- 4. Jugadores con tasa_win > 40% y nivel > 30
SELECT nick, nivel, tasa_win FROM `ejercicio-032-bas-jugadores` 
WHERE tasa_win > 40 AND nivel > 30 ORDER BY tasa_win DESC;

-- 5. Jugadores registrados en 2024
SELECT nick, fecha_reg, nivel FROM `ejercicio-032-bas-jugadores` 
